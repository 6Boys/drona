        ...
        <div
          ...
          <div>
            <Button variant="secondary" size="sm" className="gap-4">
              Swipe, connect, or just lurk <MoveRight className="w-4 h-4" />
            </Button>
          </div>
          <div className="flex gap-4 flex-col">
            ...
            <p
              ...
              Navigating student life can be chaotic. Cut through the noise by sharing,
               discovering, and connecting anonymously. Our platform makes gossip, memes, 
               and dating simpler, faster, and more fun than ever.
            </p>
          </div>
